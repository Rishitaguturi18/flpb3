...
function preload(){
  bgImg = loadImage("YellowCloud.png")
  bgImg2 = loadImage("assets/Tree_simple_is_the_best.png")

  balloonImg = loadAnimation("bee_moving.png","bee_moving2.png","bee_moving3.png")
  
  obsTop1 = loadImage("bear.png")
  obsTop2 = loadImage("bomb.png")
  
  obsBottom1 = loadImage("assets/obsBottom1.png")
  obsBottom2 = loadImage("blue_car.png")
  obsBottom3 = loadImage("assets/obsBottom3.png")
  
  gameOverImg= loadImage("game_over.png"),
  restartImg = loadImage("assets/restart.png")

jumpSound = loadSound("jumppp.mp3");
dieSound = loadSound("diee.mp3.flac");
...
bottomGround = createSprite(500,600,800,20);
...
{
  if(World.frameCount % 60 === 0) {
    obstacleBottom = createSprite(500,450,40,50);
